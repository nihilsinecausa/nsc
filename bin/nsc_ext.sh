...
#
# Dieses Script startet das Hauptscript für das nsc-improvefile-Verfahren unter Verwendung 
#     von dynamisch angelegten ext Ramdisks
# Aufruf erfolgt mit "nsc_ext.sh"
